...
namespace Astrology
{
    public partial class balik : System.Web.UI.Page
    {
        ...
        private string GetHoroscopeFromDatabase(string burcAdi, string type, DateTime date)
        {
            ...
            string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|/HoroscopeDatabase.mdb";
            string query;
        ...
        private Dictionary<string, string> GetGeneralPropertiesFromDatabase(string burcAdi)
        {
            ...
            string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|/genel_ozellikler.mdb";
