<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AlcalanBurc.aspx.cs" Inherits="Astrology.AlcalanBurc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        .transparent-panel {
            ...
            width: 80%;
            margin-top: 150px; /* Yukarıdan 100px boşluk bırakır */
            margin-bottom: 20px; /* Alttan 20px boşluk bırakır */
            overflow-y: auto; /* Yatay kaydırmayı gizler */
        }
        .header-with-image {
        ...
        .header-with-image img {
            ...
            height: auto;
            margin-left: 20px;/* Yüksekliğin otomatik ayarlanması */
        }
        .panel-content {
            margin: 5px;
            padding: 20px;
            font-size: 18px;
            text-align: center;/* Metin boyutunu belirtin */
        }
        .form-group {
            margin-bottom: 15px;
