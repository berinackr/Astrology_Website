<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="Astrology.Main" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <style>
         .transparent-panel {
            ...
            width: 80%;
            margin-top: 10px; /* Yukarıdan 100px boşluk bırakır */
